...
Modelo de **{{dominio}}**: {{sistema, formalismo y finalidad del modelo}}.

## Entrada y autoridad

- Usa `README.md` como entrada humana y declara las fuentes y, si corresponde, el corpus del formalismo elegido.
...
- {{rutas reales del modelo fuente y formatos mantenidos}}
- {{derivados que no se editan directamente y forma de regenerarlos, si existen}}
