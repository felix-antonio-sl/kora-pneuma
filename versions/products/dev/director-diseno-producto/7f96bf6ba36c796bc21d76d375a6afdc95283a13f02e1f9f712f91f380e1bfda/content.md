...
`[E#]` y una fuente válida —una entrada literal de `I_self`, una fuente leída o
...
una comprobación ejecutada sobre lo generado sí cuenta dentro de su alcance, pero
nunca como corroboración externa ni como conducta observada del producto.
