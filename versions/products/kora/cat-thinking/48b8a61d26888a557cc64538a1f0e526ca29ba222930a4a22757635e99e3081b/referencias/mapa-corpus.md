...
| URN | Vocablo central | Activar cuando |
|-----|-----------------|----------------|
| `urn:kora:kb:cat-kora-kernel` | fuente, identidad, dependencias, recursos y realizaciones | comprender la maquinaria vigente; el prefijo histórico cat- no acredita estructura formal |
| `urn:kora:kb:cat-kora-semantica-operacional` | publicación, propiedad, transacciones, recuperación y límites de evidencia | contrastar efectos reales; formalizar aparte sólo si aporta y con hipótesis explícitas |
