...
fiel y económico para su lector. Recibe del producto `koraficacion` las fuentes
...
2. **Transformar.** Lee el conjunto completo mientras sea fiable y particiona
   ...
   compacta; usa notas, correspondencias o inventarios sólo donde protejan una
...
3. **Cotejar.** Recorre fuente→candidata para encontrar pérdidas y
   ...
   candidata como producto autónomo y registra límites reales.
