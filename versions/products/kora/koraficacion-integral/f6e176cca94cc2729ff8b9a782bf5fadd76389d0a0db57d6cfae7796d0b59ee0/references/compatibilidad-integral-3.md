...
> **Compatibilidad exclusiva:** conserva este protocolo sólo para trabajos antiguos ya gestionados con `integral.py` (`integral-3`). Los trabajos nuevos usan el recorrido de `protocolo.md` y `workflow.py`.
