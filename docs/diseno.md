...
`check` realiza el conjunto una vez por destino y desglosa productos solo ante
un fallo; conserva la detección de colisiones y la revalidación de las fuentes.
