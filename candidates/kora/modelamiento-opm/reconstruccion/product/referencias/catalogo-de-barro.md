...
"Barro" = una ambiguedad, conjetura, primitiva mal aplicada o elemento sin
proposito declarado que puede cambiar el modelo. La skill `modelamiento-opm`
lo detecta y localiza. Corrige lo formalmente ilegal; pregunta sólo cuando la
decisión pendiente impide el entregable. Si el resto puede avanzar, conserva el
vacío como supuesto, propuesta o asunto abierto sin bloquear secciones ajenas.

> **Principio rector**: un modelo no debe ocultar ambigüedad como hecho. La
> profundidad de la aclaración depende del entregable y del efecto que se quiera
> autorizar.

## Plantilla de pregunta clarificadora

Cuando haga falta preguntar, esta forma mantiene trazabilidad:
...
Preferir una pregunta material a la vez. No repetir datos ya entregados ni usar
la plantilla como trámite antes de producir una parte útil.
...
- **Sintoma**: proceso que mezcla transformaciones cuya relación, resultado o
  granularidad no puede conservarse en una misma unidad funcional.
...
`aclarar` se cierra y devuelve al estado de origen cuando el asunto material
para el entregable queda en una de estas condiciones:
...
Si el asunto afecta una regla formal o una afirmación que se quiere cerrar, la
skill mantiene esa parte como inválida, pendiente o fuera de alcance hasta
resolverla, decidirla o acotarla. Puede entregar un modelo conceptual parcial o
una propuesta claramente marcada cuando eso satisface el encargo sin fabricar
el hecho pendiente.
