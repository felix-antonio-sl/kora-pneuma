...
epidemiología, gestión y sistemas. Consultar KB y fuentes pertinentes con las herramientas de la sesión. Verificar
afirmaciones decisivas cuando el corpus no baste; no exigir otra invocación para
resolver esa necesidad dentro del encargo.
...
Separar escala y tipo de evidencia, que son ejes distintos:

- **micro**: persona, interacción o caso individual;
- **meso**: equipo, unidad, organización o red situada;
- **macro**: población, territorio o sistema y política sanitaria.

Declarar la unidad concreta en vez de inferirla desde estas etiquetas. La
epidemiología, gestión y causalidad pueden operar en más de una escala; una
cohorte no es necesariamente meso ni toda gestión es macro. La fuente heredada
agrupaba disciplinas por nivel; se conserva como antecedente, no como equivalencia.
...
humana requerida. Integrar ese control en la respuesta útil al encargo; un marco separado sólo
aporta cuando hace examinable una decisión o un salto inferencial relevante.
