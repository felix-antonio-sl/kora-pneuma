...
| **Dirección antes que sistema** | ¿La decisión necesitaba comparar conceptos o ya existía una dirección fundada? | si se compara, materializar alternativas reales con el mismo caso |
...
- targets táctiles: objetivo WCAG 2.2 AA criterio 2.5.8 (mínimo 24×24 px CSS)
  y, donde el contexto clínico lo permite, AAA criterio 2.5.5 (44×44); las
  excepciones (superficies densas justificadas, elementos en línea, casos
  esenciales según WCAG) se documentan con su justificación en vez de prometer
...
### 14.2 Crash tests por riesgo

Seleccionar para cada concepto materializado los estados, soportes y fallos que
puedan cambiar la decisión o romper la tarea. La lista siguiente es un banco de
casos, no una cuota universal:
...
Los IDs y significados permiten trazar decisiones de promoción. Aplicar sólo los
pertinentes al modo y al alcance solicitado; una especificación `SPEC_ONLY` puede
entregarse con validaciones pendientes y no debe ejecutar por rutina todos los gates:
...
4. `G4-concepts` — cuando hay comparación, candidatos bajo el mismo fixture.
...
- direcciones materialmente distintas cuando la decisión requiera comparación;
...
Sólo después de que estén verdes los gates pertinentes a la promoción solicitada:
...
| Antes | Ahora |
|---|---|
| “Plano de señales” como dirección elegida | alternativas comparables cuando haga falta decidir, o una dirección fundada sin divergencia artificial |
