...
- {{recursos técnicos ejecutables, si existen, y condiciones de uso autorizado}}
- Preserva procedencia, disenso, límites de evidencia y una sola fuente por objeto.

## Verificación

{{comandos o revisión concreta para comprobar la integridad y utilidad del corpus}}
