...
|---|---|---|
| Operación matemática rutinaria | S0 Luna Max | checker exacto |
| Demostración abstracta rival | S4 Sol High/Max | candidatas aisladas, adjudicación posterior |
| Cambio de código local | S0 | un escritor y test focal |
| Bug con causa desconocida | S4 Sol High | hipótesis falsables independientes |
...
- Caso simple o resumen diagnóstico: S0; Luna Max sólo con oráculo fuerte y sin
  juicio clínico pendiente; de otro modo Sol High.
- Diferencial complejo con hipótesis rivales: S4 Sol High o Max, candidatas aisladas y
...
Una decisión local puede ser `S0 · Sol high`. Elevar a Sol Max sólo por
complejidad excepcional. Usar S2 solo si perspectivas
...
Ideas rutinarias con criterio verificable: `S0 · Luna max`. Elaboración con
juicio usa Sol High; síntesis creativa excepcional puede usar Sol Max. Usar S4 sólo si la diversidad
