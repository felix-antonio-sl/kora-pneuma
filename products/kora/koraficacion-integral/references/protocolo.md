...
|---|---|
| «Resolución N.º 8: apruébese el procedimiento X del hospital Y; entra en vigencia en marzo de 2026» | Expresa procedimiento, ámbito e inicio declarado una vez. El número de resolución y la fórmula de aprobación quedan en la procedencia; no les dediques una sección. |
