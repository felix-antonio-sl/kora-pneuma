...
mandato, versiones, cobertura y capacidades vigentes. Lee
`references/operations.md` para la API. El recurso `runtime/` contiene el paquete
`gtd_felix`. En la sesión nativa usa
