...
class OrchestrationWorker:
    ...
    def _prompt(self, job, events, item=None):
        ...
        return ('Eres el principal GTD configurado. Lee gtd_read(view="instructions") y trabaja '
                ...
                'Si esta captura precisa un asunto existente, vincúlala primero mediante clarify '
                'destination=existing e intent_basis y termina; el servicio revisará el destino en su propio job. '
                'No edites otro asunto desde el job de captura ni agotes la reserva reexplorando sus fuentes. '
                'Si ya hay material que evaluar, comienza con gtd_read(view="assessment_context", '
                'item_id, material_id, version) para preparar criterio, texto y candidatos de evidencia. '
                'Comprueba pertinencia y omisiones antes de elegir las citas; amplía sólo la fuente necesaria. '
                'La evaluación estructurada aporta diagnósticos independientes, no una explicación del Noul. '
                'Si el recibo es evaluated pero no favorable, conserva su judgment al registrar la brecha '
                'con satisfied=false y propone la reparación concreta; no repitas para buscar aprobación. '
                'En el destino, guarda pronto una versión útil del material con las precisiones ruteadas '
                'y las fuentes vigentes; declara la cobertura pendiente antes de ampliar la búsqueda. '
