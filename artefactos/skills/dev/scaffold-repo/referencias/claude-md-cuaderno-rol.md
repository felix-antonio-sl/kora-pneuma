...
Contrato operativo de Claude Code para este cuaderno. Codex usa su contrato autónomo
en `AGENTS.md`; las fuentes de verdad del dominio se declaran por separado.
