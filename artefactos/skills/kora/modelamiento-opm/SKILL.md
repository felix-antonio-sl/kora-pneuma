...
| Realizacion OPD | `urn:fxsl:kb:spec-forja-opd-es` (v1.2.0) | SSOT visual de opforja: geometria, canvas, render, edicion visual, export y bisimetria visual. |
| Realizacion OPL | `urn:fxsl:kb:spec-forja-opl-es` (v1.2.2) | SSOT textual de opforja: vocabulario cerrado, plantillas, parseo, edicion textual, roundtrip y GAPs. |
| Metodo Forja | `urn:fxsl:kb:metodologia-forja-opm-es` (v1.5.1) | SSOT primaria del metodo: A0-A8, heuristicas, lecciones Forja, bundle y disciplina humano-agente. |
