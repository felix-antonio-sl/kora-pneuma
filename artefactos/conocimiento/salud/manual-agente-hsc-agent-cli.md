...
Edición `1.0.14`, sincronizada el 2026-07-15 con
`hsc-agent-cli@804bb37` (`v3.0.0`, contrato `beta-3`) y su guía inline
...
- **Fuente MANUAL con `clinical_warning` permanente**: planilla de la unidad, no
  sistema institucional. SGH y Drive tienen temporalidad y gobernanza distintas;
  el CLI expone procedencia y no elige cuál prevalece.
